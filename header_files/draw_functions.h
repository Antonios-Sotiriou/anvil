...
const void fillGeneral(Pixel **pixels, float **depth_buffer, float **shadow_buffer, const Triangle t, Phong model, const float minX, const float maxX, const float minY, const float maxY);
