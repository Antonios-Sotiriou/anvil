...
const void texGeneral(Pixel **pixels, float **depth_buffer, float **shadow_buffer, Triangle t, Phong model, const float winding, Pixel **texels, const int tex_height, const int tex_width);
