...
const void shadowGeneral(float **shadow_buffer, const Triangle t, const float winding) {
    ...
    // const float x = t.v[0].x + (barycentric * (t.v[2].x - t.v[0].x));
    // const float z = t.v[0].z + (barycentric * (t.v[2].z - t.v[0].z));
    // const float z = t.v[0].y + (barycentric * (t.v[2].y - t.v[0].y));
    ...
    // printf("t.v[0].x: %f,    t.v[0].y: %f,    t.v[0].z: %f\n", up.v[0].x, up.v[0].y, up.v[0].z);
    // printf("t.v[1].x: %f,    t.v[1].y: %f,    t.v[1].z: %f\n", up.v[1].x, up.v[1].y, up.v[1].z);
    // printf("t.v[2].x: %f,    t.v[2].y: %f,    t.v[2].z: %f\n", up.v[2].x, up.v[2].y, up.v[2].z);
    Triangle down = {
        .v[0] = t.v[1],
        .v[1] = newVec,
        .v[2] = t.v[2],
    ...
    shadowNorthway(shadow_buffer, up, winding);
    shadowSouthway(shadow_buffer, down, winding);
